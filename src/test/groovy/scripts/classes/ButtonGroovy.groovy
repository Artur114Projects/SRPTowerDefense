...
class ButtonGroovy extends GuiButton {
    ...
    public ButtonGroovy(int buttonId, int x, int y, int width, int height, ResourceLocation atlas, int atlasSizeX, int atlasSizeY, int atlasIndex) {
        super(buttonId, x, y, "");
