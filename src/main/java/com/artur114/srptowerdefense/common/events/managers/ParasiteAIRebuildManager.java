...
//            attribute.setBaseValue(attribute.getAttributeValue() * 2);
            ...
            Iterator<EntityAITasks.EntityAITaskEntry> iterator = parasite.tasks.taskEntries.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                if (entry.priority >= 4) {
                    ret.add(parasite.tasks.new EntityAITaskEntry(entry.priority + 1, entry.action));
                } else {
                    ret.add(entry);
                }
            ...
            parasite.tasks.taskEntries.addAll(ret);
            ...
            TowerDefenceEntity data = parasite.getCapability(InitCapabilities.TD_ENTITY_DATA, null);
            if (data != null) {
